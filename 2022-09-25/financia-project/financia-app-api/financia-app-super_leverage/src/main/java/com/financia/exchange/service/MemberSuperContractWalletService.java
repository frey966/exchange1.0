...
public interface MemberSuperContractWalletService extends IService<MemberSuperContractWallet> {
     ...
     * @return
     */
    MemberSuperContractWallet findByMemberIdAndContractCoin(Long memberId, Long contractId,String entrustOrder);
     ...
     * @return
     */
    List<MemberSuperContractWallet> findAllByMemberId(Long memberId);
     ...
     * @return
     */
    List<MemberSuperContractWallet> findAllNeedSync(SuperContractCoin contractCoin);
     ...
     * @return
     */
    List<MemberSuperContractWallet> findByPositionIsNotZero();
