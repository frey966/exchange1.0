...
import com.financia.system.crypto.tron.common.utils.ByteArray;
 ...
 */
public class Tron {
	private static Logger logger = LoggerFactory.getLogger(Tron.class);
	 ...
	 * @return
	 */
	public static String signAndBroadcast(String tronUrl,String privateKey,JSONObject transaction) throws IOException, NoSuchAlgorithmException {
		if(tronUrl.endsWith("/")){
