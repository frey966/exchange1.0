package com.financia.system.crypto.tron.common.crypto.sm2;

import com.financia.system.crypto.tron.common.crypto.ECKey;
import com.financia.system.crypto.tron.common.crypto.SignInterface;
import com.financia.system.crypto.tron.common.crypto.SignatureInterface;
import com.financia.system.crypto.tron.common.crypto.jce.ECKeyFactory;
import com.financia.system.crypto.tron.common.crypto.jce.TronCastleProvider;
import com.financia.system.crypto.tron.common.utils.ByteUtil;
...
import static com.financia.system.crypto.tron.common.utils.BIUtil.isLessThan;
import static com.financia.system.crypto.tron.common.utils.ByteUtil.bigIntegerToBytes;
import static com.financia.system.crypto.tron.common.utils.Hash.computeAddress;
  ...
  public static class SM2Signature implements SignatureInterface {
    ...
    public static SM2Signature decodeFromDER(byte[] bytes) {
      ...
      try {
        ...
        return new SM2Signature(r.getPositiveValue(), s.getPositiveValue());
      } catch (IOException e) {
