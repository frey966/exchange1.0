...
public interface ContractCoinMapper extends BaseMapper<ContractCoin>
{
     ...
     * @param openFee
     */
    @Update("update ex_contract_coin coin set coin.total_open_fee=coin.total_open_fee+#{openFee} where coin.id = #{cid}")
     ...
     * @param closeFee
     */
    @Update("update ex_contract_coin coin set coin.total_close_fee=coin.total_close_fee+#{closeFee} where coin.id = #{cid}")
     ...
     * @param amount
     */
    @Update("update ex_contract_coin coin set coin.total_loss=coin.total_loss+#{amount} where coin.id = #{cid}")
     ...
     * @param amount
     */
    @Update("update ex_contract_coin coin set coin.total_profit=coin.total_profit+#{amount} where coin.id = #{cid}")
