...
public class JsonFormat {
	...
	protected static void mergeField(Tokenizer tokenizer, ExtensionRegistry extensionRegistry, Builder builder) throws ParseException {
	...
	private static void handleMissingField(Tokenizer tokenizer, ExtensionRegistry extensionRegistry, Builder builder) throws ParseException {
		tokenizer.tryConsume(":");
	...
	private static void handleValue(Tokenizer tokenizer, ExtensionRegistry extensionRegistry, Builder builder, FieldDescriptor field, ExtensionInfo extension, boolean unknown) throws ParseException {
		Object value = null;
		if (field.getJavaType() == JavaType.MESSAGE) {
	...
	private static Object handleObject(Tokenizer tokenizer, ExtensionRegistry extensionRegistry, Builder builder, FieldDescriptor field, ExtensionInfo extension, boolean unknown) throws ParseException {
		Builder subBuilder;
		if (extension == null) {
		...
		public String consumeString() throws ParseException {
			...
			if (quote != '"' && quote != '\'') {
				...
				try {
					...
					this.nextToken();
					return result;
				} catch (InvalidEscapeSequence var4) {
