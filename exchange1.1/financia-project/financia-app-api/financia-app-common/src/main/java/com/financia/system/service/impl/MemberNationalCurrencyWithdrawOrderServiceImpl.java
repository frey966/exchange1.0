...
public class MemberNationalCurrencyWithdrawOrderServiceImpl implements IMemberNationalCurrencyWithdrawOrderService
{
    ...
    public int insertMemberNationalCurrencyWithdrawOrder(MemberNationalCurrencyWithdrawOrder memberNationalCurrencyWithdrawOrder)
    {
        ...
        memberWalletNationalCurrency.setCoinId(Integer.parseInt(memberNationalCurrencyWithdrawOrder.getCoinId()));
        memberWalletNationalCurrency.setMemberId(Long.parseLong(memberNationalCurrencyWithdrawOrder.getMemberId()));
        ...
        memberWalletNationalCurrency.setMoney(memberNationalCurrencyWithdrawOrder.getMoney());
        if(!ObjectUtils.isEmpty(memberWalletNationalCurrencyResult)){
            //有则修改法币余额
            if(!(memberWalletNationalCurrencyService.subMoney(memberWalletNationalCurrency)>0)){
