...
public class MemberRegisterController extends BaseController {
    ...
    public AjaxResult verify(@RequestBody Map<String, String> param) {
        ...
        if(StringUtils.isEmpty(param.get("verificationCode2")) && StringUtils.isEmpty(param.get("verificationCode"))){
            return AjaxResult.error("verification code must be filled");
        }
