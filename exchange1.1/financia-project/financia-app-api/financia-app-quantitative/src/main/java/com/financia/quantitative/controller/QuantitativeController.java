...
public class QuantitativeController extends BaseController {
    ...
    public AjaxResult list() {
        List<FinanceTradingProject> list = projectService.list(new QueryWrapper<FinanceTradingProject>()
                ...
                .gt(FinanceTradingProject::getDepositEndTime,new Date())
                .lt(FinanceTradingProject::getDepositBeginTime,new Date()));
    ...
    public AjaxResult buy(@RequestBody Map<String, Object> param) {
        ...
        Integer pu = Integer.parseInt(param.get("purchase").toString());
        BigDecimal purchase = new BigDecimal(pu);
...
//    }
    ...
    public AjaxResult statistical() {
        ...
        rs.put("matures", matures == null ? new BigDecimal(0.00).setScale(2, RoundingMode.DOWN).toString() : matures.setScale(2, RoundingMode.DOWN).toString());
        rs.put("revenue", revenue == null ? new BigDecimal(0.00).setScale(2, RoundingMode.DOWN).toString() : revenue.setScale(2, RoundingMode.DOWN).toString());
        rs.put("yesterday", yesterday == null ? new BigDecimal(0.00).setScale(2, RoundingMode.DOWN).toString() : yesterday.setScale(2, RoundingMode.DOWN).toString());
        rs.put("totalDeposit", totalDeposit == null ? new BigDecimal(0.00).setScale(2, RoundingMode.DOWN).toString() : totalDeposit.setScale(2, RoundingMode.DOWN).toString());
        rs.put("legalTotalDeposit", totalDeposit == null ? new BigDecimal(0.00).setScale(2, RoundingMode.DOWN).toString() : remoteMemberWalletService.convertFiatCurrencyFeign(totalDeposit, userId).toString());
