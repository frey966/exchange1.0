...
public interface MemberCurrencyWalletService extends IService<MemberCryptoCurrencyWallet> {
     ...
     * @return
     */
    MemberCryptoCurrencyWallet findByCoinIdAndMemberId(Long memberId, Long coinId, String defaultLegal);
     ...
     * @return
     */
    List<MemberCryptoCurrencyWallet> findByMemberId(Long memberId, String defaultLegal);
