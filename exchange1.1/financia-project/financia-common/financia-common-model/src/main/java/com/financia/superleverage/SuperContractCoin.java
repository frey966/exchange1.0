...
@Data
@TableName("ex_super_contract_coin")
@ApiModel(value="SuperContractCoin",description = "超级杠杆交易币")
public class SuperContractCoin {

    @TableId(type = IdType.AUTO)
    @ApiModelProperty(value = "超级杠杆ID")
    private Long id;
