 ...
 */
@Data
@TableName("ex_super_contract_order_entrust")
@ApiModel(value="SuperContractOrderEntrust",description = "超级杠杆委托订单")
public class SuperContractOrderEntrust implements Serializable {
