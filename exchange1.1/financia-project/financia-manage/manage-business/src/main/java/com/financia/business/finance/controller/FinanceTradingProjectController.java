...
//    @Log(title = "量化理财-理财产品信息", businessType = BusinessType.UPDATE)
    ...
    public AjaxResult edit(@RequestBody FinanceTradingProject financeTradingProject)
    {
        ...
        return toAjax(financeTradingProjectService.update(financeTradingProject,new QueryWrapper<FinanceTradingProject>()
                .lambda()
                .eq(FinanceTradingProject::getFinanceId,financeTradingProject.getFinanceId())));
    }
