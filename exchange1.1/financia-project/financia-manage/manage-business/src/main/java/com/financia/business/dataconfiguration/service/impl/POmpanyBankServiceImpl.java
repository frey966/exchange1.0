...
import com.financia.business.dataconfiguration.mapper.POmpanyBankMapper;
...
public class POmpanyBankServiceImpl implements IPOmpanyBankService
{
    ...
    {
        pOmpanyBank.setCreateTime(DateUtils.getNowDate());
    ...
    {
        pOmpanyBank.setUpdateTime(DateUtils.getNowDate());
